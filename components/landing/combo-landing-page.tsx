...
function ComboHero({ curso }: Props) {
  ...
  return (
    <section className="pt-16 pb-20 px-6" style={{ backgroundColor: "#05070c" }}>
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 space-y-6">
            ...
            {/* H1 */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight text-white text-balance leading-tight">
              {headline}
            </h1>
          ...
          <div className="flex-shrink-0 w-full md:w-72 lg:w-80">
            {hasImage ? (
              ...
              >
                <Smartphone size={48} style={{ color: "rgba(0,212,200,0.4)" }} />
