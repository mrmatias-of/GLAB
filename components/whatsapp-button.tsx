...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-end group" style={{ width: 'auto', height: 'auto' }}>
      {/* Tooltip label */}
      ...
      >
        ...
        {/* Button body */}
        <span className="relative z-10 rounded-full bg-[#25d366] flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.4)] hover:shadow-[0_4px_40px_rgba(37,211,102,0.65)] hover:scale-110 transition-all duration-300" style={{ width: '56px', height: '56px' }}>
          <svg
