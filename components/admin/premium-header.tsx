          ...
          <div className={`relative transition-all duration-300 ${
            ...
            <div className="relative flex items-center px-3 py-2 gap-2">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-sm text-slate-300 placeholder-slate-600 flex-1 w-full"
              />
            </div>
          </div>

          {/* Notifications */}
          <button className="p-2 rounded-lg hover:bg-slate-800/50 transition-colors relative group">
