  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      if (method === 'CARD') {
        ...
        if (securityCode.length < 3) throw new Error('Informe o código de segurança (CVV) do cartão.')
