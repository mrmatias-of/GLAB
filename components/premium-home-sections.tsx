...
const areas = [
  { icon: Wrench, number: "01", title: "Fundamentos da bancada", text: "Eletrônica, multímetro, ferramentas, segurança ESD e triagem profissional.", color: "from-cyan-400/20" },
  { icon: Smartphone, number: "02", title: "Reparos e periféricos", text: "Telas, baterias, conectores, câmeras, áudio, sensores e danos por líquido.", color: "from-sky-500/20" },
  { icon: CircuitBoard, number: "03", title: "Diagnóstico e placa", text: "Consumo, curto, esquemas, PMIC, imagem, rede e falhas intermitentes.", color: "from-blue-500/20" },
  { icon: Microscope, number: "04", title: "Microsolda e componentes", text: "SMD, trilhas, pads, BGA, conectores delicados e memórias mobile.", color: "from-indigo-500/20" },
  { icon: Radio, number: "05", title: "Especialização Apple", text: "Panic logs, carga, Face ID, backlight e placas sanduíche de iPhone.", color: "from-violet-500/20" },
  { icon: Settings2, number: "06", title: "Software e dados", text: "Android, iOS, firmware oficial, recuperação, backup e privacidade.", color: "from-purple-500/20" },
  { icon: Layers3, number: "07", title: "Gestão profissional", text: "Precificação, processos, estoque, atendimento, qualidade e marketing local.", color: "from-fuchsia-500/20" },
  { icon: Gauge, number: "08", title: "PC & Performance", text: "Hardware, notebooks, Windows, estabilidade, temperatura e otimização real.", color: "from-pink-500/20" },
]
  ...
  return <>
    ...
    <section className="relative overflow-hidden px-5 py-24 md:px-8 md:py-36 xl:px-12">
      ...
      <div className="relative mx-auto max-w-[1360px]">
        ...
        <div className="mt-14 grid gap-4 md:grid-cols-2 xl:grid-cols-4">{areas.map((area) => <article key={area.number} className="group relative min-h-[300px] overflow-hidden rounded-[28px] border border-white/[.09] bg-[#090c17] p-7 transition duration-500 hover:-translate-y-2 hover:border-cyan-300/25">
